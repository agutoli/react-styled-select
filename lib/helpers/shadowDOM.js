  ...
  exports.default = function (element) {
    return function (_React$PureComponent) {
      ...
      function ShadowDOMHelper(props) {
        ...
        _this.applyStylesheet = function (node) {
          var generatedClassName = node.state.generatedClassName;

          var style = document.querySelector('[data-styled-components*="' + generatedClassName + '"]');
          if (!style) {
            return;
          }
          _this.styleTag.innerHTML = style.innerHTML;
        };
