  ...
  var WrapperSelect = function (_React$PureComponent) {
    ...
    _createClass(WrapperSelect, [{
        ...
        if (_values.size) {
          ...
          content = Array.from(_values).map(function (value, key) {
            return _react2.default.createElement(
              SelectValueComp,
              { value: value, onRemoveTag: _this9.onRemoveTagBinded, key: key, className: classes.selectValue, 'data-select-value': true, 'data-multi-value': multi },
              valueRenderer({ multi: multi, value: value, label: (_this9.optionsMap[value] || {}).label }, classes.selectValueLabel)
            );
          });
      ...
      value: function renderSelectMenuVirtualizedOptions(selectOptions) {
        ...
        return _react2.default.createElement(
          _SelectMenuVirtualized2.default,
          {
