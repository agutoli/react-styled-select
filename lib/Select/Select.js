        ...
        if (values.size) {
          content = Array.from(values).map(function (value, key) {
            return _react2.default.createElement(
              SelectValueComp,
              { key: key, className: classes.selectValue, 'data-select-value': true, 'data-multi-value': multi },
              valueRenderer({ value: value, label: _this4.optionsMap[value].label }, classes.selectValueLabel)
            );
          });
        }
